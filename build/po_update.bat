xgettext --from-code=UTF-8 -o ..\ctrl-w.pot -L JavaScript --package-name=ctrl+w --copyright-holder=" " --msgid-bugs-address=http://twd.io/e/KKyl0g --add-comments=Translators: ..\CTRLW.user.js
