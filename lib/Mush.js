...
JqEx.loading = function(jq) {
	jq.prepend("<img class='cdLoading' src='/build/img/icons/ui/loading1.gif' alt='loading...' />");
}
JqEx.postLoading = function(jq) {
	jq.append("<img class='cdLoading' src='/build/img/icons/ui/loading1.gif' alt='loading...' />");
	return jq;
}
