...
Main.k.setuptranslations = function() {
	...
	text.HEROES_SHORTDESC = [
		...
		"Vintage Astro-Physicist. Allegedly a descendant of Copernicus...",
		"Grand Achitect of the Daedalus. His knowledge of the ship is unmatched.",
		...
		"Head of security aboard the Daedalus. A blaster-toting psychopath.",
		...
		"Everyone on board is important, but she is Humanity's last hope!",
		"Reclusive cat-loving quantum physicist prodigy and electronics genius.",
		"Ship-owning combat-ready caffeine-junkie.",
